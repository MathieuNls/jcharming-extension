...
\red{Tools and approaches that rely on instrumentation face common limitations such as the needs to instrument the source code in order to introduce logging mechanisms\cite{Narayanasamy2005,Jaygarl,Artzi2008}, which is known to slow down the subject system. 
...
\red{In order to overcome these limitations, some researchers have proposed to use different SMT solvers \cite{Dutertre2006} and even model checking techniques \cite{Visser2003}. 
