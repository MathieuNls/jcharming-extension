...
\author{Mathieu Nayrolles \corrauth $^,$ \footnotemark[2] $^,$ $^1$, Abdelwahab Hamou-Lhadj$^1$, Sofi\`ene Tahar$^1$ and Alf Larsson$^2$}

\address{\begin{center}$^1$ ECE, Concordia University, Montr\'eal, Canada \\
$^2$ PLF System Management, Ericsson, R \& D, Stockholm, Sweden\end{center}}
