...
JPF designers have opted for a depth-first traversal with backtracking  because of its ability
to check for temporal liveness properties.
Currently, the JPF model checker can check deadlocks, invariants, and user-defined code assertions as same as LTL (Linear Time Logic) properties.}
