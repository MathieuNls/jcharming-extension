...
Figures \ref{fig:testing-toy} to \ref{fig:dchecking-toy}.\red{ We used the typical Java grammar for representing stack traces \cite{LucaDallOlioChristianCassano2008} to represent crash traces.} The crash trace contains a call to the {\tt Bar.foo()}
...
crash trace, the byte code of the SUT, and the entry point. From
