...
\begin{table}[H]
\centering
\caption{Effectiveness of JCHARMING using directed model checking (DMC) in minutes, \red{length of the generated JUNIT test (CE length)} and model checking (MC) in minutes}
