...
\red{\\This paper extends our previous work \cite{Nayrolles2015}, with the following contributions: an extensive validation of JCHARMING on larger scale systems, {\it i.e}, Mahout, Hadoop and, Axis2 with 10 more bugs. We further reduce the space search required to reproduce bugs, therefore improving the performances, and improve the accuracy of JCHARMING from 85\% to 91\%. Furthermore, we provide a more elaborated and up-to-date related work.}
