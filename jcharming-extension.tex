...
\red{Unlike model checking, directed model checking is not complete. Model checking ensures that a system is absolutely correct. In this work, our objective is to not to ensure absolute correctness of the program, but to use directed model checking to "hunt" for a bug within the program.}
